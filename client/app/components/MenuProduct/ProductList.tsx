...
import type { ProductListProps } from "@/app/types/product";
import { useProductStore } from "@/app/stores/useProductStore";

const ProductList = ({ childCategories, allProducts }: ProductListProps) => {
  const { handleSelectProduct } = useProductStore();
  return (
    <div>
      {childCategories.map((child) => {
        // Lọc sản phẩm thuộc danh mục con này
